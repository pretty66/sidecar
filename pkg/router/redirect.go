...
func (r *RouterRule) NetHTTPRuleMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
...
func (r *RouterRule) Rule(uniqueID, method, path string, headerFunc HeaderFunc, shadowFunc func(request *ShadowRequest)) (remoteURL string, err error) {
	r.lock.RLock()
...
func copyReqBody(src, dst *http.Request) {
	var bodyBytes []byte
	if src.Body != nil {
